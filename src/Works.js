...
class Works extends React.Component{
    constructor(props){
		...
		["友達光電股份有限公司","TFT-LCD Cell FEOL排程最佳化"],
		["台達電子工業股份有限公司","機台健康診斷(五)：利用模型殘差診斷機械振動與外擾力"],
		["工業技術研究院","外包交期不確定性推估技術委託驗證-萬用啟發式排程演算法"],
		["工業技術研究院","外包交期不確定性推估技術委託驗證-生產平準化方法"],
		["南茂科技股份有限公司 ","外包交期不確定性推估技術委託驗證-生產平準化方法"],
		["南茂科技股份有限公司 ","外包交期不確定性推估技術委託驗證-生產平準化方法"],
		["台達電子工業股份有限公司 ","以分層式架構進行機構之健康診斷(四)"],
            ]
        }
    }
